 ...
 * @author AV-IT-PC428
 */
public class insert_rma_check extends HttpServlet {
...
//            out.print(arrli_unit_serial_1);
//            out.print(arrli_customer_ref_1);
//            out.print(arrli_prb_des_1);
//            out.print(arrli_shipment_date_1);
//            part_no wise rma_no
//master insert    *** START ***
...
//                    ps1.setString(2, (String) arrli_product_part_1.get(p));
//                    ps1.setString(3, (String) arrli_cutomer_name_1.get(p));
//                    ps1.setInt(4, prod_temp);
...
//            }
//master insert    *** END ***
            String get_unit_serial_for_part = "";
            for (int k = 0; k < arrli_product_part_1.size(); k++) {
                for (int s = k + 1; s < arrli_product_part_1.size(); s++) {
                    if (arrli_product_part_1.get(k).equals(arrli_product_part_1.get(s))) {

                        ResultSet rs_get_partno_dup = st.executeQuery("select unit_serial_no from new_rma_tracker where product_part='" + arrli_product_part_1.get(s) + "'");
                        while (rs_get_partno_dup.next()) {
                            get_unit_serial_for_part = rs_get_partno_dup.getString(1);

                            if (get_unit_serial_for_part.equals(arrli_unit_serial_1.get(s))) {
//                            response.setContentType("text/html");
//                            out.println("<script type=\"text/javascript\">");
//                            out.println("alert('" + arrli_product_part_1.get(s) + "');");
//                            out.println("</script>");
                                ...
                                PreparedStatement ps1 = con.prepareStatement("insert into new_rma_master(rma_no,part_no,customer_name,serial_no_qty,added_by,added_date)values(?,?,?,?,?,?)");
                                ps1.setString(1, rma_no);
                                ps1.setString(2, (String) arrli_product_part_1.get(k));
                                ps1.setString(3, (String) arrli_cutomer_name_1.get(k));
                                ps1.setString(4, "1");
                                ps1.setString(5, username);
                                ps1.setString(6, currDate);
                                b = ps1.executeUpdate();
                                ...
                                ps.setString(2, (String) arrli_unit_serial_1.get(k));
                                ps.setString(3, (String) arrli_customer_ref_1.get(k));
                                ps.setString(4, (String) arrli_prb_des_1.get(k));
                                ps.setString(5, (String) arrli_failure_type_1.get(k));
                                ps.setString(6, (String) arrli_rma_req_date_1.get(k));
                                ps.setString(7, (String) arrli_plant_1.get(k));
                                ps.setString(8, (String) arrli_cutomer_name_1.get(k));
                                ps.setString(9, (String) arrli_product_part_1.get(k));
                                ps.setString(10, (String) arrli_product_part_name_1.get(k));
                                ps.setString(11, (String) arrli_production_order_1.get(k));
                                ps.setString(12, (String) arrli_lot_no_1.get(k));
                                ps.setString(13, (String) arrli_lot_no_1.get(k));
                                ps.setString(14, (String) arrli_shipment_date_1.get(k));
...
//                for (int l = k + 1; l < arrli_product_part_1.size(); l++) {
//
//                    if (arrli_product_part_1.get(k).equals(arrli_product_part_1.get(l))) {
//
////                            response.setContentType("text/html");
////                            out.println("<script type=\"text/javascript\">");
////                            out.println("alert('Duplicate Serial_no  " + unit_serial[i] + "');");
